...
"""
This model doesn't use reinforcement learning to find answers.
It uses LSTM to encode conversation history and current question to a embedding
then use ComplEx to find answers. It's similar to EmbedKGQA.
It's used to rank all entities, because RL based method can only find the top-K candidates

This code is the same as ./pretrain_QA_model, usually, we use ./pretrain_QA_model instead of this file
"""
