...
class Experiment:
    ...
    def __init__(self, learning_rate=0.0005, ent_vec_dim=200, rel_vec_dim=200, 
        ...
        self.cuda = cuda
        if self.cuda:
            self.cuda_num = torch.device('cuda:2')
...
## --dataset MetaQA_half --num_iterations 1000 --batch_size 256 \ --lr 0.005 --dr 1.0 --edim 200 --rdim 200 --input_dropout 0.2 \ --hidden_dropout1 0.2 
## --hidden_dropout2 0.3 --label_smoothing 0.1 \ --valid_steps 10 --model ComplEx \ --loss_type BCE --do_batch_norm 1 --l3_reg 0.0
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset", type=str, default="wikidata", nargs="?",
                    help="Which dataset to use: wikidata.")
